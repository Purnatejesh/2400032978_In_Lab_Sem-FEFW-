  ...
  return (
    <div className="app-container">
      ...
      <p className="app-subtitle">
        Enter a city name and press <strong>Get Weather</strong>.
      </p>
      ...
      <footer className="app-footer">
        <div>
          Note: This example uses OpenWeatherMap's current weather endpoint.
          Set your API key in <code>.env</code> as{' '}
          <code>VITE_OPENWEATHER_API_KEY=772fd6708c1be1023192</code>.
        </div>
      </footer>
    </div>
  );
